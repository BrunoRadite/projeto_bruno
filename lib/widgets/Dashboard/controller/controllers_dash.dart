...
import 'package:plataforma_gox/models/usuario.dart';
...
//===================Projeto===========================
  ...
  //TODO: Não esta excluindo, ajeitar essa logica.
...
//======================= CRUD resultado =====================================
  ...
  void addOneResultado(String nomeResultado,
    ...
    int indiceObjetivo = _listObjects.indexWhere(
        (element) => element.idObjetivo == idObjetivoPai); //Calcular Sweep pai
  ...
  void removeResultado2(String idResultado) async {
    int indice = _listResults
        .indexWhere((element) => element.idResultado == idResultado);
    ...
    if (indice != -1) {
      ...
      for (var metric in vinculo) {
        print('___${metric.nomeMetrica}');
        print("___${metric.toJson()}");
        valM.add(metric.toJson());
        print("___${valM.length}");
      }
      _listMetrics.removeWhere((element) => element.idResultado == idResultado);
      ...
      var a = _listResults.removeAt(indice);
      val.add(a.toJson());
      double sweepFatia = 360 / _listResults.length;
      double startAngle = 0;
...
//======================= CRUD donos =====================================
  ...
  void addOneDono(String nomeDono, String emailDono) async {
    var uuid = Uuid();
    //TODO: verificar se nome e email ja existir
...
//========================== METAS ATUALIZA E TRAVA ============================
  ...
  void travarMetaMetrica(
    ...
    if (indice != -1) {
      ...
      // if (indexObj != -1) {
      //   _listObjects[indexObj].meta =
      //       metaObjetivos(_listObjects[indexObj].idObjetivo!);
      // }
